      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[92vh] overflow-y-auto shadow-2xl border border-slate-200 p-6 md:p-8 space-y-8 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between space-y-6 hover:border-slate-300 transition-all">
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-600">Perfect for startup founders testing their first remote EA or Admin intern.</p>
              </div>

              <div className="space-y-2.5 pt-4 border-t border-slate-100 text-xs">
                <div className="flex items-center gap-2 text-slate-700">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" />
                  <span><strong>1 active job</strong> listing</span>
                </div>
                <div className="flex items-center gap-2 text-slate-700">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" />
                ...
                <div className="flex items-center gap-2 text-slate-700">
                  <Check className="w-4 h-4 text-emerald-500 shrink-0" />
                  <span>View candidate portfolios & tools</span>
                </div>
                <div className="flex items-center gap-2 text-slate-400">
                  <X className="w-4 h-4 text-slate-300 shrink-0" />
                  <span>Featured top job placement</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold text-xs py-3 rounded-xl transition-all"
            >
              Start Free Plan
            </button>
          </div>
          ...
          <div className="bg-slate-900 text-white rounded-2xl p-6 border-2 border-teal-500 shadow-xl relative flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-4 pt-1">
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-300">Cheaper than traditional job boards with 10x higher candidate engagement.</p>
              </div>

              <div className="space-y-2.5 pt-4 border-t border-slate-800 text-xs">
                <div className="flex items-center gap-2 text-slate-200">
                  <Check className="w-4 h-4 text-teal-400 shrink-0" />
                  <span><strong>10 active jobs</strong> allowance</span>
                </div>
                <div className="flex items-center gap-2 text-slate-200">
                  <Check className="w-4 h-4 text-teal-400 shrink-0" />
                  <span><strong>1 Featured Job</strong> listing included ($5 value)</span>
                </div>
                <div className="flex items-center gap-2 text-slate-200">
                  <Check className="w-4 h-4 text-teal-400 shrink-0" />
                  <span>Higher applicant visibility & direct messaging</span>
                </div>
                <div className="flex items-center gap-2 text-slate-200">
                  <Check className="w-4 h-4 text-teal-400 shrink-0" />
                  <span>Advanced candidate tool & timezone filters</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-teal-500 hover:bg-teal-400 text-slate-950 font-extrabold text-xs py-3 rounded-xl shadow-lg shadow-teal-500/20 transition-all flex items-center justify-center gap-1.5"
            >
              <Zap className="w-4 h-4" /> Upgrade to Pro ($6/mo)
            </button>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between space-y-6 hover:border-slate-300 transition-all">
            <div className="space-y-4">
              <div className="space-y-1">
                <span className="text-xs font-bold text-indigo-600 uppercase tracking-wider">Agencies & Enterprise</span>
                ...
                <p className="text-xs text-slate-600">For agencies and scale-ups hiring multiple remote team roles continuously.</p>
              </div>

              <div className="space-y-2.5 pt-4 border-t border-slate-100 text-xs">
                <div className="flex items-center gap-2 text-slate-700">
                  <Check className="w-4 h-4 text-indigo-600 shrink-0" />
                  <span><strong>Unlimited active jobs</strong></span>
                </div>
                <div className="flex items-center gap-2 text-slate-700">
                  <Check className="w-4 h-4 text-indigo-600 shrink-0" />
                  <span><strong>3 Featured Job listings</strong> per month</span>
                </div>
                <div className="flex items-center gap-2 text-slate-700">
                  <Check className="w-4 h-4 text-indigo-600 shrink-0" />
                  <span>Priority 1-on-1 candidate matching support</span>
                </div>
                <div className="flex items-center gap-2 text-slate-700">
                  <Check className="w-4 h-4 text-indigo-600 shrink-0" />
                  <span>Full access to candidate database & direct outreach</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs py-3 rounded-xl transition-all flex items-center justify-center gap-1.5"
            >
              <Crown className="w-4 h-4 text-amber-400" /> Select Business ($16/mo)
            </button>
          </div>
